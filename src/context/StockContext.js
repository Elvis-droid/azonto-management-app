...
export function StockProvider({ children }) {
  ...
  const getMonthlyProfit = useCallback(
    (month, year) => {
      ...
      return { totalRevenue, totalCost, totalProfit, itemsSold, records: recordsThisMonth };
    },
    [salesRecords]
  );
  ...
  const getOverallTotals = useCallback(() => {
    ...
    return { totalStockValue, totalRevenue, totalCost, totalProfit, totalProductsTracked };
  }, [stockItems, salesRecords]);
